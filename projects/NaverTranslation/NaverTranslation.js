...
function scwu_main() {
    ...
    scwu.show_tl = function() {
        var translation = scwu.tl_data.translation;
        var new_box;
    ...
    scwu.load_tl = function(loc) {
        scwu.xmlHttpRequest({
            method : "GET",
               url : loc,
            onload : function(responseText) {
                scwu.tl_response = req.responseText;
                if (scwu.tl_response) {
                    scwu.tl_data = $Json(scwu.tl_response.replace(/\/\/.+?\n/g,"")).$value();
                    if (scwu.tl_data) {
                        scwu.show_tl();
                    }
                }
    ...
    scwu.insert_tl_guide = function(b) {
        if (b) {
            scwu.guide.style.top = (scwu.create.base_top+16) + "px";
    ...
    scwu.convert_tl = function() {
        ...
        for (var i=0; i<scwu.tl_data.length; i++) {
            if (scwu.tl_data.removed) continue;
